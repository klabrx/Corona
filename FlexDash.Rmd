...
```{r, Old_Code, eval=TRUE, echo=FALSE}
...
Diese "eingefrorenen Schnellmeldungen" sind für die Beurteilung von Öffnungs-/Schließungsregelungen maßgeblich.

```{r, Schwellen, eval=TRUE, echo=FALSE}
kable(Schwellen, col.names = c("Grenzwert","max. Fallzahl", "seit Tag(en)"), align="ccc", format = "html", table.attr = "style='width:100%;'")
# print(Schwellen, row.names = FALSE)
```

### Fallzahlenrückblick über `r backweek-1` Wochen:
